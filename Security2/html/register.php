        ...
        <div class="mb-6">
          ...
          <div class="border border-slate-300 rounded-lg p-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                <label for="zipcode" class="block mb-1 text-sm font-medium text-gray-700">Zip Code<span class="text-xs mt-1" style="color: red;" >*</span></label>
                <input id="zipcode" name="zip_code" type="text" required maxlength="5"
                  class="border border-gray-300 p-2 rounded focus:outline-none focus:border-blue-500 w-full"
