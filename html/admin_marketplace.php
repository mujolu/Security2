...
<head>
    ...
    <title>Marketplace Archives - Artlab Super Admin</title>
    <style>
...
<aside class="w-64 bg-gray-800 min-h-screen p-6 flex flex-col">
    ...
    <nav class="flex flex-col gap-4 mt-8">
        ...
        <a href="admin_marketplace.php" class="sidebar-link bg-yellow-700 text-white rounded-lg px-4 py-3">Marketplace Art</a>
...
<main class="flex-1 p-6">
    <header class="bg-gray-800 text-white rounded-xl p-6 mb-6 flex justify-between">
        <h3 class="text-xl font-bold">Marketplace Art Archives</h3>
        <a href="logout.php" class="bg-gray-700 px-4 py-2 rounded hover:bg-yellow-700">Logout</a>
    </header>

    <section class="bg-white rounded-xl shadow-lg p-6">
        <h2 class="text-2xl font-bold mb-4">Marketplace Art Archives</h2>
        <p class="text-gray-600">No content yet. This page will display archived marketplace art.</p>
    </section>
