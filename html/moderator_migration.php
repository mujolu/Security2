<?php
// Migration tool: Check moderators in both tables and optionally migrate them
    ...
    if ($_POST['action'] === 'migrate_all') {
        try {
            ...
            if (count($moderators) > 0) {
                ...
                $migration_status = "✓ Successfully migrated $count moderator(s) to registered_users table!";
            } else {
                $migration_status = "No moderators found in old moderators table";
            }
        } catch (Exception $e) {
...
<html>
<head>
    <title>Moderator Migration Tool</title>
    <style>
...
<body>
    <div class="container">
        <h1>👥 Moderator Migration Tool</h1>
        ...
        <div class="section">
            ...
            try {
                ...
                if (count($old_mods) > 0) {
                    echo '<p class="warning">Found ' . count($old_mods) . ' moderator(s) in old table:</p>';
                    echo '<table>';
                    ...
                    // Migration form
                    echo '<div class="info">';
                    echo '<strong>⚠️ These moderators are NOT in registered_users!</strong><br>';
                    ...
                    echo '<button type="submit">Migrate All Moderators to registered_users</button>';
                    echo '</form>';
                } else {
                    echo '<p>✓ No moderators in old table</p>';
                }
            } catch (Exception $e) {
            ...
            try {
                ...
                if (count($new_mods) > 0) {
                    echo '<p class="success">Found ' . count($new_mods) . ' moderator(s) in registered_users:</p>';
                    echo '<table>';
                    ...
                    echo '<p class="warning">⚠️ No moderators in registered_users table!</p>';
                    echo '<p>Use the admin panel to add moderators, or migrate them from the old table above.</p>';
                }
            } catch (Exception $e) {
        ...
        <div class="section">
            <h2>✅ Test Login</h2>
            <p>Once you have moderators in the registered_users table, test their login credentials:</p>
        ...
        <div class="section">
            <h2>📋 What to Do</h2>
            <h3>Option 1: Migrate Existing Moderators (Recommended if you already added them)</h3>
            <ol>
                <li>Look at "Old moderators Table" above - if it shows moderators, click the migration button</li>
                <li>After migrating, the moderator should appear in "New registered_users Table"</li>
                <li>The moderator can now login with their username and password</li>
            </ol>

            <h3>Option 2: Add New Moderators via Admin Panel</h3>
            <ol>
                <li>Go to: <a href="admin_dashboard.php" target="_blank">Admin Dashboard</a></li>
                <li>Click "Deploy Moderators"</li>
                <li>Click "Create Moderator" button</li>
                <li>Fill in moderator details (First Name, Last Name, Email, Username, Password)</li>
                <li>Click Submit</li>
                <li>The new moderator will be added to registered_users automatically</li>
                <li>The moderator can now login with their username and password</li>
            </ol>
        </div>
    </div>
